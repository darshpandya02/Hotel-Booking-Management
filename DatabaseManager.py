...
global con, cur
con = connector.connect(host='localhost', port='3306', user='root', password='Darsh@0201', database='hoteldatabase')
cur = con.cursor()
...
def addDefaultValues():
    queries = [
        "insert into customerdetails values(115,'8729328473','Darsh Pandya',22,'9876543210','682 Parker Street, Boston',1500,'2023-11-12','2023-11-13')",
        ...
        "insert into roomtype values(2,2,'AC',3500,'Deluxe double room with AC, two single beds, a wardrobe and an pool facing window')",
        "insert into roomtype values(3,2,'AC',4500,'Supreme double room with AC, two single beds, a wardrobe and an outward facing window')",
        "insert into roomtype values(4,2,'AC',4500,'Supreme Deluxe double room with AC, two single beds, a wardrobe and an hill facing window')",
        "insert into roomtype values(5,2,'AC',4500,'Suite double room with AC, two single beds, a wardrobe and an pool facing window')",
        "insert into room values(188,1,268)",
        "insert into room values(188,2,268)",
        "insert into room values(188,3,268)",
        "insert into room values(188,4,268)",
        "insert into room values(188,5,268)",
